...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { close: @price.close, high: @price.high, low: @price.low, open: @price.open, other: @price.other, ticker: @price.ticker, when: @price.when }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { close: @price.close, high: @price.high, low: @price.low, open: @price.open, other: @price.other, ticker: @price.ticker, when: @price.when }
    assert_redirected_to price_path(assigns(:price))
  end
